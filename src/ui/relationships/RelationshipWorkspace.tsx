...
export function RelationshipWorkspace({ focusPersonId, people, relationships, parentChildLinks, organizations, personCommunityIds, relationshipsTruncated, onSelectPerson, onShowTimeline, onShowMap, onSelectOrganization }: {
