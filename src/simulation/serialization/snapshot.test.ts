...
describe('canonical serialization', () => {
  ...
  it('round-trips schema 11 households, communities, development, and named streams', async () => {
    ...
    expect(validated.schemaVersion).toBe(11)
    expect(validated.engineVersion).toBe('0.11.0')
