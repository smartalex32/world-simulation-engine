...
export interface SimulationEventPayloadMap {
  ...
  ORGANIZATION_STRUCTURE_CHANGED: { reconciliationJson: string; traceSequence: number; transitionKind: string; sourceOrganizationIds: string; resultOrganizationIds: string; memberPersonIds: string; livingMemberCount: number; sharedMemberCount: number; relationshipEvidenceCount: number; reason: string }
  ...
  ORGANIZATION_LEADERSHIP_CHANGED: { traceSequence: number; organizationId: string; roleId: string; outcome: string; previousLeaderPersonId?: string; selectedLeaderPersonId?: string; contested: boolean; reason: string }
  ORGANIZATION_DECISION_PROPOSED: { proposalSequence: number; organizationId: string; policyId: string; resolvesAtTick: number; participantIds: string; participantRoles: string; alternativeIds: string }
  ORGANIZATION_DECISION_RESOLVED: { proposalSequence: number; organizationId: string; policyId: string; participantIds: string; participantRoles: string; factorWeightsPermille: string; knowledgeId: string; alternativeIds: string; finalScoresPermille: string; probabilitiesPermille: string; rngStream: string; randomRollPermille: number; selectedAlternativeId: string; authorizedEffectIds: string }
...
export const EVENT_CATALOG = {
  ...
  ORGANIZATION_STRUCTURE_CHANGED: entry('ORGANIZATION_STRUCTURE_CHANGED', 'durable', [{ reconciliationJson: 'string', traceSequence: 'number', transitionKind: 'string', sourceOrganizationIds: 'string', resultOrganizationIds: 'string', memberPersonIds: 'string', reason: 'string' }]),
  ...
  ORGANIZATION_LEADERSHIP_CHANGED: entry('ORGANIZATION_LEADERSHIP_CHANGED', 'durable', [{ traceSequence: 'number', organizationId: 'string', roleId: 'string', outcome: 'string', contested: 'boolean', reason: 'string' }]),
  ORGANIZATION_DECISION_PROPOSED: entry('ORGANIZATION_DECISION_PROPOSED', 'durable', [{ proposalSequence: 'number', organizationId: 'string', policyId: 'string', resolvesAtTick: 'number', participantIds: 'string', participantRoles: 'string', alternativeIds: 'string' }]),
  ORGANIZATION_DECISION_RESOLVED: entry('ORGANIZATION_DECISION_RESOLVED', 'durable', [{ proposalSequence: 'number', organizationId: 'string', policyId: 'string', participantIds: 'string', participantRoles: 'string', factorWeightsPermille: 'string', knowledgeId: 'string', alternativeIds: 'string', finalScoresPermille: 'string', probabilitiesPermille: 'string', rngStream: 'string', randomRollPermille: 'number', selectedAlternativeId: 'string', authorizedEffectIds: 'string' }]),
