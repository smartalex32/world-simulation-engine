...
| --- | --- | --- | --- | --- |
| 51 — Persistence Compatibility and Deterministic Portability | [#120](https://github.com/smartalex32/world-simulation-engine/issues/120) | [#55](https://github.com/smartalex32/world-simulation-engine/pull/55), [#131](https://github.com/smartalex32/world-simulation-engine/pull/131) | Authenticated source-before-transform migrations, fresh target digests, provenance, an explicit current-plus-prior-two schema window, immutable historical-release fixtures, and guarded hosted snapshot backup/job reconciliation; worker request failure handling and locale-independent hosted ordering. | Transactional telemetry imports and broader browser/server historical-fixture coverage. |
| 52 — Maintainability and Performance Foundation | [#121](https://github.com/smartalex32/world-simulation-engine/issues/121), [#123](https://github.com/smartalex32/world-simulation-engine/issues/123), [#125](https://github.com/smartalex32/world-simulation-engine/issues/125) | [#56](https://github.com/smartalex32/world-simulation-engine/pull/56), [#132](https://github.com/smartalex32/world-simulation-engine/pull/132), [#134](https://github.com/smartalex32/world-simulation-engine/pull/134) | Extracted reusable projection location indexes and stable ordering; added retained-builder correctness, explicit noncanonical invalidation across browser and hosted execution, independent static/dynamic cache lifetimes, viewport-bounded living-environment derivation, a fixed deterministic engine phase pipeline, and runtime-owned browser/host command contracts with a shared engine-command application service and correlated acknowledgements. | UI controller extraction, remaining projection separation and measured incremental indexes, hosted CI typecheck, and measured 10k non-regression. |
