...
| --- | --- | --- | --- | --- |
| 51 — Persistence Compatibility and Deterministic Portability | [#120](https://github.com/smartalex32/world-simulation-engine/issues/120), [#124](https://github.com/smartalex32/world-simulation-engine/issues/124) | [#55](https://github.com/smartalex32/world-simulation-engine/pull/55), [#131](https://github.com/smartalex32/world-simulation-engine/pull/131), [#135](https://github.com/smartalex32/world-simulation-engine/pull/135) | Authenticated source-before-transform migrations, fresh target digests, provenance, an explicit current-plus-prior-two schema window, immutable historical-release fixtures, guarded hosted snapshot backup/job reconciliation, worker request failure handling, locale-independent hosted ordering, and one structured canonical-state validator across creation, restoration, runtime commands, and persistence. | Transactional telemetry imports and broader browser/server historical-fixture coverage. |
| 52 — Maintainability and Performance Foundation | [#121](https://github.com/smartalex32/world-simulation-engine/issues/121), [#123](https://github.com/smartalex32/world-simulation-engine/issues/123), [#125](https://github.com/smartalex32/world-simulation-engine/issues/125) | [#56](https://github.com/smartalex32/world-simulation-engine/pull/56), [#132](https://github.com/smartalex32/world-simulation-engine/pull/132), [#134](https://github.com/smartalex32/world-simulation-engine/pull/134), [#136](https://github.com/smartalex32/world-simulation-engine/pull/136) | Extracted reusable projection location indexes and stable ordering; added retained-builder correctness, explicit noncanonical invalidation across browser and hosted execution, independent static/dynamic cache lifetimes, viewport-bounded living-environment derivation, a fixed deterministic engine phase pipeline, shared browser/host command execution, and injected session, draft, and persistence controllers. | Remaining projection separation and measured incremental indexes, shared helpers, hosted CI typecheck, and measured 10k non-regression. |
